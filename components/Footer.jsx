...
const Footer = () => {
  ...
  const linkSections = [
    {
      title: "Các loại cây",
      links: [
        { text: "Cây vú sữa", path: "category/cayvusua", icon: null },
        { text: "Cây tùng", path: "category/caytung", icon: null },
        { text: "Cây sang", path: "category/caysang", icon: null },
        { text: "Cây khế", path: "category/caykhe", icon: null },
        { text: "Cây bàng", path: "category/caybang", icon: null },
        { text: "Cây hồng", path: "category/cayhong", icon: null },
      ],
    },
    {
      title: "Liên hệ",
      links: [
        { text: "0326621539", path: "/", icon: PhoneIcon },
        {
          text: "Cầu Mai Lĩnh - Biên Giang - Chương Mỹ - Hà Nội",
          path: "/",
          icon: MapPinIcon,
        },
      ],
  ...
  return (
    <footer className="mx-6 bg-white mb-15">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            <Link href="/" className="text-4xl font-semibold text-slate-700">
              <span className="text-green-600">Cây Xanh Chương Mỹ</span>
            </Link>
            <p className="max-w-[410px] mt-6 text-sm text-slate-700">
              Cây Xanh Chương Mỹ chuyên cung cấp các loại cây công trình, cây
              bóng mát, cây trồng biệt thự với chất lượng tốt nhất, giá cả phải
              chăng. Chúng tôi luôn phục vụ khách hàng với sự tận tâm, nhiệt
              tình, chuyên nghiệp. Khách hàng quan tâm có thể đến xem trực tiếp
              cây ở vườn để có thể có lựa chọn phù hợp nhất. Chúng tôi rất hân
              hạnh được tiếp đón khách hàng.
            </p>
          </div>
          <div className="flex flex-wrap justify-between w-full md:w-[100%] gap-5 text-sm ">
